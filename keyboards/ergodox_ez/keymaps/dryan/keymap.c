 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |All_T/Es|A / L2|   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |; / L2| All_T/'|
 * |--------+------+------+------+------+------|MO(L1)|           |MO(L1)|------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |   /  | RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |MO(L1)| LCtl | LAlt | Left | Right|                                       | Down |  Up  |   [  |   ]  |   =  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[BASE] = LAYOUT_ergodox(
  ...
  ALL_T(KC_ESC),   LT(MDIA, KC_A), KC_S,     KC_D,    KC_F,    KC_G,
  KC_LSFT,         KC_Z,           KC_X,     KC_C,    KC_V,    KC_B,    MO(SYMB),
  MO(SYMB),        KC_LCTL,        KC_LALT,  KC_LEFT, KC_RGHT,
  ...
  MO(SYMB),     KC_N,    KC_M,    KC_COMM, KC_DOT,     KC_SLSH,           KC_RSFT,
                         KC_DOWN, KC_UP,   KC_LBRC,    KC_RBRC,           KC_EQUAL,
